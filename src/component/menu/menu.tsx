...
const MenuList: React.FC<MenuPropsInterface> = ({ list }) => {
  ...
  return (
    ...
    <div className="absolute z-100 w-full h-full top-0 flex justify-center item-center " onClick={()=>{setIndex(null), setIsOpenModal(false)}}>
        ...
        <img src={list[index].image||img} alt="" className="mx-auto mt-2"/>
        <div className="p-3">
        ...
        <div className="text-center mt-4 ">
            <button className="rounded font-semibold bg-yellow-400 hover:bg-yellow-500 text-white px-2 py-1">Add to Cart</button>
        </div>
        </div>
